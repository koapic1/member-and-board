...
<main>
	<div class="inner">
		...
		<div id="contents">
			...
			<form method="POST" action="ReplyWriteProcess.do" id="join" class="form" enctype="multipart/formdata">
				<table>
					<colgroup>
						<col style="width: 20%">
						<col style="width: 80%">
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="text" name="email" id="user_email"
								placeholder="메일을 입력하세요." readonly value="${loggedEmail }" class="readonly"></td>
						</tr>
						<tr>
